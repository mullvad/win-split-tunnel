...
- Traffic approval to override Mullvad App WFP filters and enable excluded apps to communicate outside the tunnel.
...
This is believed to mostly affect IPC clients that utilize sockets. No generally applicable mitigations are available.
